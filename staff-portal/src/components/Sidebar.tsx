...
const ICONS = {
  ...
  revenue:       I(["M18 20V10M12 20V4M6 20v-6", "M22 20H2"]),
  admins:        I(["M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z", "M9 12l2 2 4-4"]),
  analytics:     I(["M18 20V10M12 20V4M6 20v-6"]),
  announcements: I(["M22 8.01C21.7 5.7 19.79 4 17.5 4h-11C4.01 4 2 6.01 2 8.5v7C2 17.99 4.01 20 6.5 20H11l5 3v-3h.5c2.49 0 4.5-2.01 4.5-4.5V9.01", "M8 10h8M8 14h5"]),
  support:       I(["M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"]),
  ...
  audit:         I(["M9 11l3 3L22 4", "M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"]),
};
...
const GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Revenue",       href: "/revenue",       icon: ICONS.revenue },
    ],
  },
  {
    title: "People",
    items: [
      { label: "Staff Admins", href: "/staff-admins", icon: ICONS.admins },
    ],
  },
  {
    title: "Intelligence",
  ...
  },
  {
    ...
    items: [
      { label: "Announcements", href: "/announcements", icon: ICONS.announcements },
    ],
  },
  {
    title: "Support",
    items: [
      { label: "Client Support", href: "/support", icon: ICONS.support },
    ],
  },
  {
    title: "Compliance",
